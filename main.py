...
def wrap_anniversary_text(text, max_chars=6, max_lines=3):
    """
    記念日名を折り返す。
    max_chars: 1行あたりの目安文字数
    max_lines: 最大行数
    """
...
def make_calendar(img, year, month, x_adj=0, y_adj=0, zoom=100, logo=None, cat_icon=None, cat_labels=None, holiday_labels=None, anniversaries=None, anniversary_labels=None, anniversary_holiday_labels=None, anniversary_catday_labels=None):
        ...
        for c, day in enumerate(wk):
            ...
            if matching_anniversaries:
                ...
                # 2) 猫記念日と同日
                    ...
                    label_img = (
                        anniversary_catday_labels.get(date_key)
    ...
    try:
        for month in range(1, 13):
            ...
            result = make_calendar(
                ...
                anniversary_catday_labels=anniversary_catday_labels
            )
